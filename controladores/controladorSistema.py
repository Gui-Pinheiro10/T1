...
class ControladorSistema:
    ...
    def cadastro_enfermeiro(self):
        self.__controlador_enfermeiro.abre_tela() # chama o controlador de Enfermeiros
    ...
    def cadastro_agendamento(self):
        self.__controlador_agendamento.abre_tela() # chama o controlador de Agendamentos
